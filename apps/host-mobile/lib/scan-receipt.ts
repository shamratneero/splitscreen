...
import type { ParsedReceipt } from '@splitpay/receipt-parser';
...
export async function scanReceipt(_base64: string, _mediaType: string, _onProgress?: (message: string) => void, _signal?: AbortSignal): Promise<ParsedReceipt> {
  throw new Error('Free receipt scanning is available in the web app. Open SplitPay in your browser, or enter this bill manually.');
}

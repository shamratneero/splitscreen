...
- Use tabular numerals for amounts, dates, quantities, and payment numbers. Format amounts through `@splitup/types`, including when copying a decimal currency amount.

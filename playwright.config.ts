...
export default defineConfig({
  ...
  webServer: [
    ...
    {
      command: 'corepack pnpm --filter @splitpay/guest-web exec next dev --hostname 127.0.0.1 --port 3002',
    ...
    {
      command: 'corepack pnpm --filter @splitpay/host-mobile prepare:ocr && corepack pnpm --filter @splitpay/host-mobile exec expo start --localhost --port 8082 --clear',
